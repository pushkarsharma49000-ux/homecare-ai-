...
type ServiceRequest = { id: string; request_number: string; issue: string; status: string; appliances: { brand: string; model: string } | null; appointments: { id: string; scheduled_start: string; status: string; calendar_event_id: string | null }[] };
